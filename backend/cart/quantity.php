...
if($quantityPro<=1 and $add==0) die(json_encode(["success" => false,"data" => "El producto no puede tener menos de uno"]));
...
die(json_encode(["success" => true,"data" => "Carrito Actualizado"]));
