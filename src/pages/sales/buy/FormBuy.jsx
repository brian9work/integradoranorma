...
const Inputs = [
   {
      ...
      nombre: 'Fecha de vencimiento. (Seleccione el primer dia del mes)', maxLength: 7,
      attributs: { type: 'date', minLength: '6', required: true, name: 'inputBuyExpiration', placeholder: 'MM / YYYY' }
   }, {
